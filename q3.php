...
<table border="1">
<center><h3 style="color:green">Q3.The written materials helped me understand the content of the class?<h3></center> 
...
<?php 
   include("conn.php");
      $sql = $conn->query("SELECT COUNT(practice) FROM studentdata WHERE practice='Neutral'");
      $row = $sql->fetch_row();
      $count = $row[0];
